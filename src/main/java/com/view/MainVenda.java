		...
		btnPagamentoOutro.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent arg0) {
				if(tabelaVendas.getRowCount() == 1) {
					...
					JOptionPane.showMessageDialog(null, "Para Utilizar esta fun��o apenas 1 produto � permitido no cupom");
				}
			}
		...
		btnSair.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				try {
					...
					e2.printStackTrace();
					JOptionPane.showMessageDialog(new JFrame(), "N�o Foi poss�vel finalizar");
				}
			}
		});
			...
			public void actionPerformed(ActionEvent arg0) {
				...
				if(quanti.length() != 0 || valorUnis.length() != 0) {
					try {
						...
						e.printStackTrace();
						JOptionPane.showMessageDialog(new JFrame(), "Quantidade ou Valor Inv�lido");
					}
				}else {
					JOptionPane.showMessageDialog(new JFrame(), "Quantidade ou Valor Inv�lido");
				}
