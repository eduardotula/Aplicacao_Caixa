...
import model.PrintPedidos;
import model.PrintPedidos.PrintLista;
...
public class PedidosLista extends JFrame {
	...
	public void createAndShowGUI() {
		...
		lblDescri��oP = new JLabel("Descri\u00E7\u00E3o");
		panelPedido.add(lblDescri��oP, "cell 0 0 2 1");
	...
	public class Pedidos extends JFrame {
		private DefaultModels tableModel = new DefaultModels(new String[] { "ID","Descri��o", "Cliente", "Numero", "Data" },
				new boolean[] { false,false, false, false, false },
	...
	public class Lista extends JFrame {
		private DefaultModels tableModel = new DefaultModels(
				new String[] {"ID", "Cod.Barra", "Produto", "Observa��o", "Data" },
