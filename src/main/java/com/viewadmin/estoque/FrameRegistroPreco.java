...
public class FrameRegistroPreco extends JFrame{
	...
	private DefaultModels model = new DefaultModels(new String[] {"Opera��o","Produto", "Valor Anterior","Valor Atualizado", "Hora","Data","Operador"}, 
